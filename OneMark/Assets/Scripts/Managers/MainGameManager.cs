...
public class MainGameManager : MonoBehaviour
{
    ...
    public static FollowObject mainCamera { get; private set; }
    ...
    void Awake()
	{
        ...
        mainCamera = GameObject.FindGameObjectWithTag("MainCamera").GetComponent<FollowObject>();
